...
from ...models import Bed, BedAssignment, Room, Ward
...
class TimelineView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        for assignment in assignments:
            ...
            beds = Bed.objects.filter(room=room).exclude(
                assignments__discharge_date__gte=assignment.admission_date,
                assignments__admission_date__lte=assignment.discharge_date,
            )
